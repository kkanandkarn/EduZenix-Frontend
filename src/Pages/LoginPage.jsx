...
const LoginPage = () => {
  ...
  return (
    <div className="flex h-screen bg-white dark:bg-primary">
      ...
      {/* Login form*/}
      <div className="w-1/2 h-full border flex flex-col items-center justify-center">
        {" "}
        <div className="w-3/5 flex flex-col gap-2 items-center justify-center bg-secondry rounded-lg p-6">
          ...
          <div className="w-full h-8 mt-4 flex items-center justify-center">
            <div className="flex flex-col items-center justify-center w-[40%]">
              <div className="h-1/2 border-b border-gray-400 w-full"></div>
            </div>
            <div className="w-[20%] flex items-center justify-center">
              <h1 className="text-gray-300 font-bold font-poppins">OR</h1>
            </div>
            <div className="flex flex-col items-center justify-center w-[40%]">
              <div className="h-1/2 border-b border-gray-400 w-full"></div>
            </div>
