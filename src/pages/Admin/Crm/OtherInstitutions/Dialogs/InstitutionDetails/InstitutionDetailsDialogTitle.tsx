import type { InstitutionStatus, InstitutionDetails } from "../../types";
...
const InstitutionDetailsDialogTitle = ({ state }: Props) => {
  const getChipColors = (status: InstitutionStatus) => {
    if (status === "Pending")
...
export default InstitutionDetailsDialogTitle;
