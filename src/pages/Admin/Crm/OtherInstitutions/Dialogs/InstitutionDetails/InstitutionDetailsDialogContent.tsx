...
const InstitutionDetailsDialogContent = ({ data }: Props) => {
  ...
  return (
    <>
      ...
      <Box sx={{ mt: 4, px: 4 }}>
        {data.author && <InstitutionDetailsAuthor author={data.author} />}
      </Box>
    </>
  );
};

export default InstitutionDetailsDialogContent;
