...
const CollegePage = () => {
  ...
  const [filters, setFilters] = useState<CollegeFilters>(initialFilters);
  ...
  const columnFilters: TableFilters[] = [
    ...
    },
    {
      ...
      options: [
        ...
        {
          value: 2,
          label: "Constituent / University College",
        },
        {
          value: 3,
          label: "PG Center / Off-Campus Center",
        },
        {
          value: 4,
