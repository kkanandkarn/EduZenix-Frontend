import type { CollegeDetails, CollegeStatus } from "../../types";
...
const CollegeDetailsDialogTitle = ({ state }: Props) => {
  const getChipColors = (status: CollegeStatus) => {
    if (status === "Pending")
...
export default CollegeDetailsDialogTitle;
